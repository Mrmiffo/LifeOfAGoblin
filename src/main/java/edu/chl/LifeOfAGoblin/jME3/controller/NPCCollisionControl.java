...
public class NPCCollisionControl extends AbstractControl {
    ...
    public void updateCollisionInfo(Spatial npc, Spatial collided) {
        if (npc != collided && collided.getControl(ModelControl.class).getModel() instanceof AbstractCharacter) /*&& collided.getControl(ModelControl.class).getModel().getClass() == Player.class)*/ {
            /*System.out.println("Something fishy over here!");
        } else if (collided.getControl(ModelControl.class).getModel().getClass() == Player.class) {
            System.out.println("Much better here");
        }*/
        ...
        /*if (collided.getControl(ModelControl.class).getModel().getClass() == Player.class) {
        System.out.println("NPC X: " + npcLocation.getX()/* + ", " + npcLocation.getY() + ", " + npcLocation.getZ());*/
        /*System.out.println("PLAYER X: " + collided.getLocalTranslation().getX() + ", "
                            + collided.getLocalTranslation().getY()
                            + ", " + collided.getLocalTranslation().getZ());
        }*/
