...
/**
 * The controller class for the game hud. Should only exist in on instance. Used
 * to update the displayed player health and to flash the screen when the player
 * take damage.
 *
 * @author Anton
 */
